...
public class movimentacaoTipoDespesa {
  ...
  @Test
  public void testMovimentacaoTipoDespesa() throws Exception {
    ...
    new Select(driver.findElement(By.id("tipo"))).selectByVisibleText("Despesa");
    driver.findElement(By.id("tipo")).click();
    ...
    driver.findElement(By.id("descricao")).sendKeys("teste despesa");
    ...
    driver.findElement(By.id("valor")).sendKeys("30");
    driver.findElement(By.id("conta")).click();
    driver.findElement(By.id("conta")).click();
    driver
        .findElement(
            By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Situação'])[1]/following::label[1]"))
        .click();
    driver
        .findElement(
