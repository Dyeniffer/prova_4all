...
public class criarDuasContas {
  ...
  @Test
  public void testCriarDuasContas() throws Exception {
    ...
    driver.findElement(By.id("nome")).sendKeys("Teste1");
    driver
        .findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Nome'])[1]/following::button[1]"))
        .click();
    driver.findElement(By.linkText("Contas")).click();
    driver.findElement(By.linkText("Adicionar")).click();
    driver.findElement(By.id("nome")).click();
